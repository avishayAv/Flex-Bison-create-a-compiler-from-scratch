...
CodeBuffer::CodeBuffer() : buffer(), dataDefs(), label_generator(0) {
}
...
string CodeBuffer::genLabelWithoutEmit(){  // todo: maybe refactor to gen label
	std::stringstream label;
	label << "WE_label_";
	label << this->label_generator;
